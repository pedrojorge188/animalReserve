...
public:
    Ovelha(int id, int r, int c): Animal('c',id, r, c, 3, 0, 0, 0, 0, 1, "erva", 15, 15, 4){};
    //void chanceWalk();
    //void decrNutri();
};
...
public:
    Lobo(int id, int r, int c): Animal('c',id, r, c, 5, 0, 0, 0, 0, 2, "carne", 15, 5, 10){};
    //void chanceWalk();
    //void decrNutri();
};
...
public:
    Canguru(int id, int r, int c): Animal('c',id, r, c, 7, 0, 0, 0, 0, 1, "nothing", 0, 30, 15){};
    //void chanceWalk();
    //void decrNutri();
};
...
public:
    MisteryAnimal(int id, int r, int c): Animal('c',id, r, c, 4, 0, 0, 0, 0, 1, "verdura", 10, 8, 1){};
    //void chanceWalk();
    //void decrNutri();
};
